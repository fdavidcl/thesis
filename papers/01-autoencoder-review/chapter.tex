...
%     Charte, D., Charte, F., García, S., del Jesus, M. J., \& Herrera, F. (2018). A practical tutorial on autoencoders for nonlinear feature fusion: Taxonomy, models, software and guidelines. \textit{Information Fusion, 44}, 78-96.
%   \end{kaobox}
% \end{widepar}
...
\begin{figure*}[h!]
	\centering
  \subfloat[Shallow undercomplete]{\label{p1Fig.ShallowUnder}\includegraphics[width=0.32\linewidth]{ShallowUndercomplete.pdf}}
	\qquad
  \subfloat[Shallow overcomplete]{\label{p1Fig.ShallowOver}\includegraphics[width=0.32\linewidth]{ShallowOvercomplete.pdf}}
	
  \subfloat[Deep undercomplete]{\label{p1Fig.DeepUnder}\includegraphics[width=0.32\linewidth]{DeepUndercomplete.pdf}}
	\qquad
  \subfloat[Deep overcomplete]{\label{p1Fig.DeepOver}\includegraphics[width=0.32\linewidth]{DeepOvercomplete.pdf}}
...
\begin{figure}[ht!]
  ...
  \subfloat[Recursive AE (left), unfolded recursive AE (right)]{\label{p1Fig.RecAE}\includegraphics[width=\linewidth]{ArchDualAE.pdf}}
  \caption{\label{p1Fig.AEarch}Illustrations of autoencoder-based architectures. Each rectangle represents a layer, dark gray fill represents an input, light gray represents output layers and white objects represent hidden layers.}
...
\begin{figure}[hbtp!]
  ...
  \caption{\label{p1Fig.AEvsPCA}Row 1 shows test samples, second row corresponds to PCA reconstructions, the third one shows those from a linear AE optimizing MSE, row 4 displays reconstructions from a basic AE with $\tanh$ activation and cross-entropy as loss function, and last row corresponds to a robust AE.}  
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{\label{p1Fig.enclength}First row: test samples; Remaining rows: reconstructions obtained with 16, 36, 81 and 144 units in the encoding layer, respectively.}
\end{figure}
...
\begin{figure*}[htbp]
  ...
  \caption{\label{p1Fig.mnist}Reconstructing test samples with different AE models. First row of each figure shows test samples, second row shows activations of the encoding layer and third row displays reconstructions. Encoded values range from -1 (black) to 1 (white).}
\end{figure*}
