...
\subsubsection{Class overlap}\index{class overlap}
...
\subsubsection{Class separability and nonlinearity}\index{class separability}
...
\subsubsection{Neighborhoods and morphology}\index{morphology}
...
\subsubsection{Feature space dimensionality}\index{feature!space dimensionality}
...
\subsubsection{Feature selection}\index{feature!selection}
...
\subsubsection{Nonlinear feature extraction}\index{feature!extraction}
...
\subsubsection{Distance metric learning}\index{distance metric learning}
...
\subsection{Scorer}\index{Scorer}
...
\subsection{Skaler}\index{Skaler}
...
\subsection{Slicer}\index{Slicer}
