...
\lowertitleback{
	...
	\textbf{Copyright} \\
	Part of this book is released under a CC-BY-SA copyright license. This allows you to share and modify it as long as the modifications are released under a similar license.

	To view a copy of the CC-BY-SA code, visit: \\\url{https://creativecommons.org/licenses/by-sa/4.0/}

	The published articles included in this document are printed under permission of their corresponding copyright holders.
